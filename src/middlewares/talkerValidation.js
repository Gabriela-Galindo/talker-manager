...
isTalkValid = (req, res, next) => {
    ...
    if(talk.rate === undefined) return res.status(400).json({ message: 'O campo "rate" é obrigatório' });
...
module.exports = { isTokenValid, isNameValid, isAgeValid, isTalkValid };